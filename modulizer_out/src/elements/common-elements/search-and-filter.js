...
import 'tab-inputs-styles';
import '../app-mixins/query-params-mixin.html';
import '../app-mixins/date-mixin.html';
...
class SearchAndFilter extends EtoolsMixinFactory.combineMixins([
  ...
  static get template() {
    return html`
      <style include="shared-styles module-styles tab-inputs-styles iron-flex">
        :host {
