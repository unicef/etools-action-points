...
import 'pages-header-element';
import 'search-and-filter';
import 'filters-element';
import 'etools-data-table';
import '@polymer/paper-card';
import '@polymer/iron-flex-layout,';
import 'static-data-mixin';
import 'action-points-data';
import '@polymer/iron-location';
import 'localization-mixin';
import 'date-mixin';
import 'input-attrs-mixin,';
import 'text-content';
import '@polymer/paper-tooltip';
    ...
    class ActionPointsList extends EtoolsMixinFactory.combineMixins([
      ...
      static get template() {
        return html`
          <style include="module-styles shared-styles iron-flex iron-flex-factors data-table-styles">
            :host {
              position: relative;
              display: block;
